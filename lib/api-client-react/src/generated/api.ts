...
>(options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListRecentTransactionsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listRecentTransactions>>
  > = ({ signal }) => listRecentTransactions({ signal, ...requestOptions });
 ...
 */
export const getGetBudgetsOverviewUrl = () => {
  return `/api/budgets/overview`;
};

export const getBudgetsOverview = async (
  options?: RequestInit,
): Promise<BudgetProgress[]> => {
  return customFetch<BudgetProgress[]>(getGetBudgetsOverviewUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetBudgetsOverviewQueryKey = () => {
  return [`/api/budgets/overview`] as const;
};

export const getGetBudgetsOverviewQueryOptions = <
  TData = Awaited<ReturnType<typeof getBudgetsOverview>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getBudgetsOverview>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetBudgetsOverviewQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getBudgetsOverview>>
  > = ({ signal }) => getBudgetsOverview({ signal, ...requestOptions });
...
export type GetBudgetsOverviewQueryResult = NonNullable<
  Awaited<ReturnType<typeof getBudgetsOverview>>
>;
export type GetBudgetsOverviewQueryError = ErrorType<unknown>;

/**
 * @summary Get all budgets with spending progress for current month
 */

export function useGetBudgetsOverview<
  TData = Awaited<ReturnType<typeof getBudgetsOverview>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetBudgetsOverviewQueryOptions(options);
...
export const getCashFlow = async (
  ...
  return customFetch<MonthlyFlow[]>(getGetCashFlowUrl(), {
    ...options,
    method: "GET",
  });
};
